...
class DBHead(object):
    ...
    def __call__(self, conv_features, mode="train"):
        ...
        # paddle.fluid.layers.resize_nearest(input, out_shape=None, scale=None, name=None, actual_shape=None, align_corners=True, data_format='NCHW')[
        ...
        # shrink_maps:probability maps shape[1,H,W]
        shrink_maps = self.binarize(fuse)
        if mode != "train":
            return {"maps": shrink_maps}
        # threshold_maps shape:[1,H,W]
