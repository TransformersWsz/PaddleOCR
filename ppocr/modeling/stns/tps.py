...
class LocalizationNetwork(object):
    ...
    def conv_bn_layer(self,
        ...
        conv = layers.conv2d(
            ...
            bias_attr=False)
        bn_name = "bn_" + name
        # moving_mean_name （string）- moving_mean的名称，存储全局均值。如果将其设置为None, batch_norm 将随机命名全局均值；
        # 否则， batch_norm 将命名全局均值为 moving_mean_name 。默认：None。
