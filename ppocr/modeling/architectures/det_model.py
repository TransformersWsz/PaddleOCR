...
class DetModel(object):
    def __init__(self, params):
        ...
        self.backbone = create_module(backbone_params['function'])(params=backbone_params)

        head_params = deepcopy(params["Head"])
        head_params.update(global_params)
        self.head = create_module(head_params['function'])(params=head_params)

        loss_params = deepcopy(params["Loss"])
        loss_params.update(global_params)
        self.loss = create_module(loss_params['function'])(params=loss_params)
