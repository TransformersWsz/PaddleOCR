...
def AugmentData(data):
    img = data['image']
    shape = img.shape
    # iaa.Fliplr((p=1, seed=None, name=None, random_state='deprecated', deterministic='deprecated')
    # p (number or imgaug.parameters.StochasticParameter, optional) – Probability of each image to get flipped.
    # iaa.Affine()仿射变换
    # imgaug.augmenters.size.Resize(size, interpolation='cubic', seed=None, name=None, random_state='deprecated', deterministic='deprecated')
    aug = iaa.Sequential(
