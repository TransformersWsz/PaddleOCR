...
def main():
    ...
    #                 iterable=False)
    # reader paddle.reader.multiprocess_reader(readers, False)
    ...
    if train_alg_type == 'det':
        program.train_eval_det_run(config, exe, train_info_dict, eval_info_dict,False)
    elif train_alg_type == 'rec':
        program.train_eval_rec_run(config, exe, train_info_dict, eval_info_dict,False)
    else:
        program.train_eval_cls_run(config, exe, train_info_dict, eval_info_dict,False)
...
if __name__ == '__main__':
    # preprocess() load config from yml file
